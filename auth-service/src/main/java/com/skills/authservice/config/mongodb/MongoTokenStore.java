package com.skills.authservice.config.mongodb;

import com.skills.authservice.domain.MongoAccessToken;
import com.skills.authservice.domain.MongoRefreshToken;
